...
/**
 * @author: glmapper (glmapper_2018@163.com) 2020/4/5 5:17 PM
 * @since:
 **/
@Configuration
public class MQProducerConfiguration {
    ...
    public DefaultMQProducer defaultMQProducer() throws RuntimeException {
        ...
        producer.getDefaultMQProducerImpl().registerSendMessageHook(new SofaTracerSendMessageHook(groupName));
